...
const Payments = () => {
  const [payments] = useState([
    { id: 1, invoice: "INV-2025-001", amount: "$450.00", date: "2025-01-15", method: "Credit Card", status: "Paid" },
    { id: 2, invoice: "INV-2025-002", amount: "$325.00", date: "2025-01-14", method: "Insurance", status: "Pending" },
    { id: 3, invoice: "INV-2025-003", amount: "$180.00", date: "2025-01-13", method: "Cash", status: "Paid" },
    { id: 4, invoice: "INV-2025-004", amount: "$550.00", date: "2025-01-12", method: "Debit Card", status: "Refunded" },
  ]);
